...
describe("useTagInformacaoTemplate", () => {
  it("renderiza corretamente tags com tooltip", () => {
    ...
    const tags = document.querySelectorAll("[data-tooltip-html]");
    expect(tags[0].getAttribute("data-tooltip-html")).toContain("Texto do Hint 1");
    expect(tags[1].getAttribute("data-tooltip-html")).toContain("Linha 1<br/>Linha 2");
