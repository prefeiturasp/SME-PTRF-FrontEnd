...
const BotaoAcertosLancamentosDevolucaoAoTesouro = ({
  analise_lancamento,
      ...
      {analise_lancamento && !analise_lancamento.devolucao_tesouro_atualizada ? (
        ...
        >
          <>
            ...
            <strong>
              {" "}
              Dev.Tesouro atualizada.{" "}
              <span className="clique-aqui-atualizada mr-2">Clique para {TEMPERMISSAO ? "editar" : "ver"}</span>
            </strong>
          </>
        </LinkCustom>
      )}
