...
const BotaoAcertosLancamentosDesconciliacaoGasto = ({carregaAcertosLancamentos, conta, analise_lancamento, prestacaoDeContas, analisePermiteEdicao}) => {
                ...
                <>
                    ...
                    >
                        <FontAwesomeIcon
                            ...
                            icon={faCheckCircle}
                        />
                        <strong> Gasto atualizado. <span className='clique-aqui-atualizada'>{ TEMPERMISSAO && 'Clique para conciliar'}</span></strong>
                    </button>
                </>
            }
        </>
