...
export const TabelaAcertosDespesasPeriodosAnteriores = ({
    ...
    // Paginação
    const [primeiroRegistroASerExibido, setPrimeiroRegistroASerExibido] = useState(dados_analise_dre_usuario_logado.conferencia_de_despesas_periodos_anteriores.paginacao_atual ? dados_analise_dre_usuario_logado.conferencia_de_despesas_periodos_anteriores.paginacao_atual : 0);
            ...
            return (
                <div className="row">
                    <div className="col-12" style={{padding: "15px 0px", margin: "0px 15px", flex: "100%"}}>
                        Exibindo <span style={{color: "#00585E", fontWeight: "bold"}}>{totalDeAcertosDosLancamentos}</span> gastos de períodos anteriores pendentes de conciliação
                    </div>
                </div>
            )
        }
    ...
    const salvaEstadoPaginacaoLancamentosLocalStorage = (event) => {
        dados_analise_dre_usuario_logado.conferencia_de_despesas_periodos_anteriores.paginacao_atual = event.rows * event.page
        dados_analise_dre_usuario_logado.conferencia_de_despesas_periodos_anteriores.expanded = expandedRowsLancamentos
