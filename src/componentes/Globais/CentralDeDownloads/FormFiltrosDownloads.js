...
export const FormFiltrosDownloads = ({
  handleSubmitFormFiltros,
  stateFormFiltros,
  handleChangeFormFiltros,
  listaStatus,
}) => {
  return (
    <>
      <h5>Filtros</h5>
      <form onSubmit={handleSubmitFormFiltros} aria-label="form">
        <div className="form-row align-items-center">
          <div className="form-group col">
            <label htmlFor="filtro_por_identificador">
              Filtrar por identificador/informações
            </label>
            <input
              ...
              onChange={(e) =>
                handleChangeFormFiltros(e.target.name, e.target.value)
              }
            />
          </div>
          ...
          <div className="form-group col">
            <label htmlFor="filtro_por_atualizacao">
              Filtrar por atualização
            </label>
            <DatePickerField
