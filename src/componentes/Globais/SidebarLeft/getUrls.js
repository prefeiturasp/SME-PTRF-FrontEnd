...
const UrlsMenuEscolas ={
    ...
    lista_de_urls:[
        ...
        {label: "Gestão de usuários", url: "gestao-de-usuarios", dataFor:"gestao_de_usuarios", icone:IconeGestaoDePerfis, permissoes: ['access_gestao_usuarios_ue'],},
    ]
};
...
const UrlsMenuDres ={
    ...
    lista_de_urls:[
        ...
        {label: "Gestão de usuários", url: "gestao-de-usuarios", dataFor:"gestao_de_usuarios", icone:IconeGestaoDePerfis, permissoes: ['access_gestao_usuarios_dre'],},
    ]
};
...
const UrlsMenuSME ={
    ...
    lista_de_urls:[
        ...
        {label: "Gestão de usuários", url: "gestao-de-usuarios", dataFor:"gestao_de_usuarios", icone:IconeGestaoDePerfis, permissoes: ['access_gestao_usuarios_sme'],},
    ]
};
