...
const UrlsMenuDres ={
    ...
    lista_de_urls:[
        ...
        {label: "Gestão de usuários", url: "gestao-de-usuarios-list", dataFor:"gestao_de_usuarios", icone:IconeGestaoDePerfis, permissoes: ['access_gestao_usuarios_dre', 'change_gestao_usuarios_dre'], featureFlag: 'gestao-usuarios',},
    ]
};
...
const UrlsMenuSME ={
    ...
    lista_de_urls:[
        {label: "Parametrizações", url: "painel-parametrizacoes", dataFor:"sme_painel_parametrizacoes", icone:IconeMenuParametrizacoes, permissoes: ['access_painel_parametrizacoes', 'change_painel_parametrizacoes'],},
        ...
        {label: "Gestão de usuários", url: "gestao-de-usuarios-list", dataFor:"gestao_de_usuarios", icone:IconeGestaoDePerfis, permissoes: ['access_gestao_usuarios_sme', 'change_gestao_usuarios_sme'], featureFlag: 'gestao-usuarios',},
    ]
};
