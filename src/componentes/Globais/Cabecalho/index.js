                        ...
                        {dados_usuario_logado.unidades.map((unidade, index) => (
                          <option
                            ...
                            value={retornaVisaoConvertida(
                              ...
                              unidade.tipo_unidade === "DRE" || unidade.tipo_unidade === "SME"
                                ? unidade.nome
                  ...
                  <div className="col-3 p-0 m-0 text-right">
                    ...
                    >
                      <span className="span-icone-verde">
                        <FontAwesomeIcon style={{ fontSize: "16px", color: "#fff" }} icon={faFileDownload} />
                        <span
                          className={
                            centralDownloadContext.qtdeNotificacoesNaoLidas &&
                            centralDownloadContext.qtdeNotificacoesNaoLidas >= 10
                    ...
                    >
                      <span className="span-icone-verde">
                        <FontAwesomeIcon style={{ fontSize: "16px", color: "#fff" }} icon={faBell} />
                        <span
                          className={
                            notificacaoContext.qtdeNotificacoesNaoLidas &&
                            notificacaoContext.qtdeNotificacoesNaoLidas >= 10
                              ? `span-notificacoes-maior-que-10`
                              : "span-notificacoes-menor-que-10"
                          }
                        >
                    ...
                    <li className="link-acoes nav-link dropdown">
                      ...
                      >
                        <button className="btn-sair">
                          <span className="span-icone-verde">
                            <FontAwesomeIcon style={{ fontSize: "16px", color: "#fff" }} icon={faUser} />
                          </span>
                          <span className="span-text-dropdown">
                            {dados_usuario_logado.usuario_logado.nome
                              .toLowerCase()
                              .replace(/(?:^|\s|['`‘’.-])[^\x00-\x60^\x7B-\xDF](?!(\s|$))/g, function (a) {
                                return a.toUpperCase();
                              })}
                          </span>
                          <FontAwesomeIcon style={{ fontSize: "16px", color: "#0" }} icon={faChevronDown} />
                        </button>
                      </a>

                      <div className={`dropdown-menu dropdown-menu-opcoes`} aria-labelledby="linkDropdownAcoes">
                        <button className="btn-sair" onClick={() => navigate(`/meus-dados`)}>
                          Meus dados
                        </button>
                        <br />
                        <button className="btn-sair" data-testid="botao-sair" onClick={() => onShow()}>
                          Sair
                        </button>
                      </div>
                    </li>
