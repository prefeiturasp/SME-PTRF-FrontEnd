        ...
        <div className="row">
          <div className="col-12 mt-2">
            <InputSelect
              ...
              onChange={(e) =>
                handleChangeOrdenacao(e.target.name, e.target.value)
              }
          ...
          <div className="col-12 mt-2">
            <div className="form-group form-check">
              <input
                onChange={(e) =>
                  handleChangeOrdenacao(e.target.name, e.target.checked)
                }
              ...
              <label
                ...
                htmlFor={`ordenar_por_imposto`}
              >
                Ordenar com imposto vinculados às despesas
              </label>
            </div>
          </div>
