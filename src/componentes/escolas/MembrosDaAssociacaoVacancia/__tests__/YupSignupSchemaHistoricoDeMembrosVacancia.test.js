...
describe("YupSignupSchemaHistoricoDeMembrosVacancia", () => {
    const dadosValidos = {
        nome: "João da Silva",
    ...
    describe("campos obrigatórios", () => {
        it("deve validar um objeto válido", async () => {
            await expect(
                YupSignupSchemaHistoricoDeMembrosVacancia.validate(dadosValidos)
            ).resolves.toEqual(dadosValidos);
        });

        it("deve exigir nome", async () => {
            await expect(
                YupSignupSchemaHistoricoDeMembrosVacancia.validate({
                    ...dadosValidos,
                    nome: "",
                })
    ...
    describe("cpf_responsavel", () => {
        it("deve chamar valida_cpf_cnpj para PAI_RESPONSAVEL", async () => {
            ...
            await YupSignupSchemaHistoricoDeMembrosVacancia.validate({
                ...dadosValidos,
                representacao: "PAI_RESPONSAVEL",
                cpf_responsavel: "12345678909",
            });
        ...
        it("não deve validar CPF para SERVIDOR", async () => {
            await YupSignupSchemaHistoricoDeMembrosVacancia.validate({
                ...dadosValidos,
                representacao: "SERVIDOR",
                codigo_identificacao: "123456",
