  ...
  results: [
    {
      uuid: "uuid3",
      nome: "Ação PDDE 1",
      programa_objeto: { uuid: "prog1", nome: "Programa 1" },
    },
    {
      uuid: "uuid4",
      nome: "Ação PDDE 2",
      programa_objeto: { uuid: "prog2", nome: "Programa 2" },
    },
  ],
};
...
describe("FormFiltros", () => {
  ...
  it("seleciona tipo de aplicação CUSTEIO e habilita tipo de despesa", async () => {
    ...
    const tipoAplicacaoSelect = screen.getByLabelText(
    ...
    await waitFor(() => {
      const tipoDespesaSelect = screen.getByLabelText(
