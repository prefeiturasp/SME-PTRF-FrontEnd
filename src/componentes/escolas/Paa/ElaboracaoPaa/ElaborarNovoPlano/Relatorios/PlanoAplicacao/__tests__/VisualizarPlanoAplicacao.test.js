...
describe("VisualizarPlanoAplicacao", () => {
    ...
    describe("Renderização dos grupos", () => {
                ...
                data: [
                    {
                        ...
                        dados: [
                            ...
                            {
                                key: "prioridades-outros-recursos-total",
                                isTotal: true,
                                valor_total: 100,
                            },
                        ],
        ...
        it("renderiza os itens com descricao", async () => {
            ...
            expect(
                screen.getByRole("cell", { name: "Teste 1" }),
            ).toBeInTheDocument();

            expect(
                screen.getByRole("cell", { name: "Teste 2" }),
            ).toBeInTheDocument();
        });
    });
});
