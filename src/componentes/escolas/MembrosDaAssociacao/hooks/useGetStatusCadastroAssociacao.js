...
export const useGetStatusCadastroAssociacao = () => {
    ...
    const { isLoading: isLoading_status_cadastro_associacao, isError: isError_status_cadastro_associacao, data: data_status_cadastro_associacao, error: error_status_cadastro_associacao } = useQuery(
