...
import {getSaldosValoresReprogramados, criarValoresReprogramados} from "../../../services/escolas/ValoresReprogramados.service";
                            ...
                            <form onSubmit={props.handleSubmit}>
                                <div className="form-row">
                                    <div className="col-12 col-md-6 mt-4">
                                        ...
                                        <span className="text-danger mt-1">{props.errors.periodo}</span>}
                                    </div>
                                    ...
                                    <div className="col-12 col-md-6 mt-4">
                                        ...
                                        <span className="text-danger mt-1">{props.errors.valor_total}</span>}
                                    </div>
                                </div>
                                    ...
                                    render={({insert, remove, push}) => (
                                        <>
                                                    ...
                                                    <div key={index}>
                                                        <div className="form-row container-campos-dinamicos">
                                                            ...
                                                            <div className="col mt-4">
                                                                ...
                                                                {props.errors.acao_associacao && <span
                                                                    className="text-danger mt-1"> {props.errors.acao_associacao}</span>}
                                                            </div>
                                                            ...
                                                            <div className="col mt-4">
                                                                ...
                                                                <span
                                                                    className="text-danger mt-1"> {props.errors.conta_associacao}</span>}
                                                            </div>
                                                            ...
                                                            <div className="col mt-4">
                                                                ...
                                                                <span
                                                                    className="text-danger mt-1"> {props.errors.aplicacao}</span>}
                                                            </div>
                                            ...
                                            <div className="col-12 mt-2">
                                                <span
                                                    className="text-danger"> {props.errors.lancamemto_duplicado}</span>
                                            </div>
                                            }
                                ...
                                <div className="d-flex  justify-content-end pb-3 mt-3">
                                    <button onClick={() => getPath()} type="button"
                                            className="btn btn btn-outline-success mt-2 mr-2">Cancelar
                                    </button>
                                    <button onClick={() => onShowModalSalvar(errors, values)}
                                            disabled={btnAddValoresReprogramadosReadonly || camposObrigatorios || semSaldo}
                                            type="button" className="btn btn-success mt-2">Salvar
                                    </button>
                                </div>
