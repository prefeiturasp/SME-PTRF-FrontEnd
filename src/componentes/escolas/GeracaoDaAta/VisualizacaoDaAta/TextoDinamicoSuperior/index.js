...
export const TextoDinamicoSuperior = ({dadosAta, retornaDadosAtaFormatado}) => {
    ...
    return(
        <>
            ...
            <p>
                Aos {retornaDadosAtaFormatado("data_reuniao")}, reuniram-se os membros da {dadosAta.associacao.nome ? dadosAta.associacao.nome : "___"} do(a) {dadosAta.associacao.unidade.tipo_unidade} {dadosAta.associacao.unidade.nome ? dadosAta.associacao.unidade.nome : "___"} no(a) {dadosAta.local_reuniao ? dadosAta.local_reuniao : "___"} , para tratar da seguinte pauta: Apresentação ao Conselho Fiscal da prestação de contas da verba do PTRF
