                ...
                <>
                    ...
                    {despesas && despesas.length > 0 && Object.entries(somaDosTotais).length > 0 ? (
                            <>
                                ...
                                <TabelaDespesas
                                    despesas={despesas}
                                    onClickDespesa={redirecionaDetalhe}
                                    tipoLancamentoTemplate={tipoLancamentoTemplate}
                                    especificacaoDataTemplate={especificacaoDataTemplate}
                                    valorTotalTemplate={valorTotalTemplate}
                                />
