...
describe("metodosAuxiliares", () => {
  ...
  describe("valores e rateios", () => {
    ...
    it("deve limpar os campos exclusivos de capital ao mudar para CUSTEIO", () => {
        const setFieldValue = jest.fn();
    ...
    it("deve limpar os campos exclusivos de capital quando aplicacaoRecurso está vazio", () => {
        const setFieldValue = jest.fn();
    ...
    it("não deve alterar os campos de capital ao mudar para CAPITAL", () => {
        const setFieldValue = jest.fn();
    ...
    it("deve usar o index correto ao montar o path do rateio", () => {
        const setFieldValue = jest.fn();
