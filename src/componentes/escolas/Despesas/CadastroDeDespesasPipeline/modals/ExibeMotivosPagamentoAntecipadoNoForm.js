...
const ExibeMotivosPagamentoAntecipadoNoForm = ({values}) => {
    ...
    const exibeMotivos = () =>{
        ...
        const mostraJustificativasPagamentoAntecipado = (data_transacao && data_documento) && (data_transacao < data_documento) && 
                                                        (values.motivos_pagamento_antecipado.length > 0 || values.outros_motivos_pagamento_antecipado)
        if (mostraJustificativasPagamentoAntecipado) {
            return(
