...
import {getPeriodos, getTiposDeConta} from "../../../services/sme/ConsultaDeSaldosBancarios.service";
                    ...
                    <>
                        <nav className='mt-5'>
                            <div className="nav nav-tabs" id="nav-tab" role="tablist">
                                <a className="nav-link active" id="nav-por-tipo-de-unidade-tab" data-toggle="tab" href="#nav-por-tipo-de-unidade" role="tab" aria-controls="nav-por-tipo-de-unidade" aria-selected="true">Exibição por tipo de unidade</a>
                                <a className="nav-link" id="nav-por-dre-tab" data-toggle="tab" href="#nav-por-dre" role="tab" aria-controls="nav-por-dre" aria-selected="false">Exibição por Diretoria</a>
                                <a className="nav-link" id="nav-por-ue-dre-tab" data-toggle="tab" href="#nav-por-ue-dre" role="tab" aria-controls="nav-por-ue-dre" aria-selected="false">Exibição por tipo de UE e DRE</a>
                            </div>
                        </nav>
