...
jest.mock("../../../../../../../../services/sme/Parametrizacoes.service", () => ({
  getUnidadesNaoVinculadasTipoCusteio: jest.fn(),
}));
...
describe("useGetUnidadesNaoVinculadas", () => {
  ...
  it("deve retornar dados quando a requisição for bem-sucedida", async () => {
    ...
    getUnidadesNaoVinculadasTipoCusteio.mockResolvedValueOnce(mockData); // Simula a resposta bem-sucedida da API
  ...
  it("deve retornar erro quando a API falhar", async () => {
    getUnidadesNaoVinculadasTipoCusteio.mockRejectedValueOnce(new Error("Erro na API"));
  ...
  it("deve retornar estado de loading enquanto a requisição está em andamento", () => {
    getUnidadesNaoVinculadasTipoCusteio.mockReturnValueOnce(new Promise(() => {})); // Simula uma requisição pendente
