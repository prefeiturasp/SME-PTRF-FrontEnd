      ...
      <form>
        <div className="row">
          <div className="col-12 col-md-4">
            <label htmlFor="nome_ou_codigo">
              Buscar por nome ou código EOL da unidade
            </label>
            <input
          ...
          <div className="col-12 col-md-4">
            ...
            >
              ...
              {tiposUnidades &&
                tiposUnidades.length > 0 &&
                tiposUnidades.map((item) => (
        ...
        <div className="d-flex  justify-content-end pb-3 mt-3">
          ...
          <button onClick={handleFilter} className="btn btn-success mt-2">
            Filtrar
          </button>
        </div>
      </form>
