...
const ModalFormFornecedores = ({show, stateFormModal, handleClose, handleSubmitModalFormFornecedores, setShowModalConfirmDeleteFornecedor, temPermissaoEditarFornecedores}) => {
                                    ...
                                    <div className='col-12'>
                                        <div className="form-group">
                                            ...
                                            <input
                                                ...
                                                disabled={!temPermissaoEditarFornecedores()}
                                            />
                                ...
                                <div className="d-flex bd-highlight mt-2">
                                    <div className="p-Y flex-grow-1 bd-highlight">
                                        {values.operacao === 'edit' ? (
                                            <button onClick={()=>setShowModalConfirmDeleteFornecedor(true)} type="button" className="btn btn btn-danger mt-2 mr-2" disabled={!temPermissaoEditarFornecedores()}>
                                                Apagar
                                            </button>
                                        ): null}
                                    </div>
                                    ...
                                    <div className="p-Y bd-highlight">
                                        <button type="submit" className="btn btn btn-success mt-2" disabled={!temPermissaoEditarFornecedores()}>Salvar</button>
                                    </div>
                                </div>
                            </form>
                        );
