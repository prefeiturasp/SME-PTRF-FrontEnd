export const mockTabela = {
    "periodos": [
        ...
        },
        {
            ...
            "data_fim_realizacao_despesas": "2024-08-31",
            "data_prevista_repasse": null,
            "data_inicio_prestacao_contas": "2024-09-01",
            "data_fim_prestacao_contas": null,
            "editavel": false,
            "periodo_anterior": {
                "uuid": "043fa8a8-a030-45fb-8c33-c10b207af590",
                "referencia": "2024.1",
                "data_inicio_realizacao_despesas": "2024-01-01",
                "data_fim_realizacao_despesas": "2024-04-30",
                "referencia_por_extenso": "1° repasse de 2024"
            }
        },
        {
            "uuid": "043fa8a8-a030-45fb-8c33-c10b207af590",
            ...
            "data_inicio_realizacao_despesas": "2024-01-01",
            "data_fim_realizacao_despesas": "2024-04-30",
            "data_prevista_repasse": "2024-04-26",
            "data_inicio_prestacao_contas": "2024-01-01",
            "data_fim_prestacao_contas": "2024-04-30",
            "editavel": false,
            "periodo_anterior": {
                "uuid": "8125bd46-27db-4edf-ad9c-d1963858d80b",
                "referencia": "2023.3",
                "data_inicio_realizacao_despesas": "2023-09-01",
                "data_fim_realizacao_despesas": "2023-12-31",
                "referencia_por_extenso": "3° repasse de 2023"
            }
        }
    ],
    "tipos_contas": [
        ...
        {
            "uuid": "2a3f91d5-1f3c-4007-abd9-c51784cbc821",
            "id": 7,
            "nome": "teste",
            "banco_nome": "",
            "agencia": "",
        ...
        {
            "uuid": "1be59035-2350-42bc-8955-9fac0db069f8",
            "id": 3,
            "nome": "Teste1",
            "banco_nome": "Teste",
            "agencia": "9999",
        ...
        {
            "uuid": "fc76ea77-ece7-44a9-a94b-e1365a20c27d",
            "id": 6,
            "nome": "Banco SME",
            "banco_nome": "Banco SME",
            "agencia": "",
            "numero_conta": "",
            "numero_cartao": "",
            "apenas_leitura": false,
        ...
        {
            "uuid": "d2db175f-9e8a-4f21-9778-c26ec84bf1ee",
            "id": 9,
            "nome": "Teste 2",
...
export const mockRepasses = {
    "links": {
        "next": "http://hom-sig-escola.sme.prefeitura.sp.gov.br/api/repasses/?acao=&conta=&page=2&page_size=20&periodo=&search=&status=",
        "previous": null
    },
    "count": 7751,
    "page": 1,
    ...
    "results": [
        {
            "associacao": {
                "uuid": "f5c8cc15-dd87-4ba5-9d35-927684cb86d2",
                "ccm": "3.758.891-5",
                "cnpj": "50.864.065/0001-53",
                "email": "emei25dejaneiro@sme.prefeitura.sp.gov.br",
                "nome": "ASSOC DE PAIS E MESTRES E M E I VINTE CINCO DE JANEIRO",
                "unidade": {
                    "uuid": "c36b1098-a874-4fa7-aac0-a2a4d4c11bb7",
                    "codigo_eol": "091464",
                    "tipo_unidade": "EMEI",
                    "nome": "25 DE JANEIRO",
                    "nome_com_tipo": "EMEI 25 DE JANEIRO",
                    "sigla": "",
                    "dre": {
                ...
                "id": 460,
                "processo_regularidade": "6016.2022/0019281-0"
            },
            "uuid": "3553484d-8227-41fb-854d-ccddd321742e",
            "valor_capital": "0.00",
            "valor_custeio": "11260.00",
            "valor_livre": "0.00",
            "acao_associacao": {
                "uuid": "29be5b97-4daf-4360-8419-30eca3611358",
                "id": 3605,
            ...
            "conta_associacao": {
                "uuid": "ab8ad1be-28bd-49ee-a8f6-88c83c12e0bf",
                "nome": "Cheque",
                "status": "ATIVA",
            ...
            "carga_origem": "acoes_associacoes_hom_iGxNX38.csv",
        ...
        {
            "associacao": {
                "uuid": "a005730d-72e2-4d62-a662-566c42103e54",
                "ccm": "3.762.052-5",
                "cnpj": "08.227.624/0001-58",
                "email": "ceijsaoluiz1@sme.prefeitura.sp.gov.br",
                "nome": "ASSOCIACAO DE PAIS E MESTRES DO CEI JARDIM SAO LUIZ I",
                "unidade": {
                    "uuid": "77201067-0c98-4ae0-acd2-0edafcded02d",
                    "codigo_eol": "400125",
                    "tipo_unidade": "CEI DIRET",
                    "nome": "JARDIM SAO LUIZ I",
                    "nome_com_tipo": "CEI DIRET JARDIM SAO LUIZ I",
                    "sigla": "",
                    "dre": {
            ...
            "uuid": "130a703e-ee27-4e0b-948b-901cd89ac13d",
            "valor_capital": "0.00",
            "valor_custeio": "0.00",
            "valor_livre": "14778.00",
            "acao_associacao": {
                "uuid": "b32056cb-3aba-429d-a50c-84102350a27a",
                "id": 423,
                "nome": "PTRF Básico",
                "e_recursos_proprios": false,
                "acao": {
            ...
            "conta_associacao": {
                "uuid": "1cbe8e4a-034a-4cc1-b8a5-853e4e416213",
                "nome": "Cartão",
                "status": "ATIVA",
                "solicitacao_encerramento": null,
            ...
            "realizado_custeio": false,
            "realizado_livre": false,
            "carga_origem": "2024_09_01_a_2024_12_31_cartao_2_ptrf_bVIUrzw.csv",
            "carga_origem_linha_id": 19,
            "id": 23609,
            "campos_editaveis": {
                "campos_identificacao": true,
                "valor_capital": true,
        ...
        {
            "associacao": {
                "uuid": "1c4452b7-264c-4317-9322-51c9a8d55791",
                "ccm": "3.762.143-2",
                "cnpj": "08.240.951/0001-40",
                "email": "ceicidfranco@sme.prefeitura.sp.gov.br",
                "nome": "ASSOCIACAO DE PAIS E MESTRES DO CEI VEREADOR CID FRANCO",
                "unidade": {
                    "uuid": "5a9c5363-1d9d-4905-84aa-3a747ab56875",
                    "codigo_eol": "400026",
                    "tipo_unidade": "CEI DIRET",
                    "nome": "CID FRANCO, VER.",
                    "nome_com_tipo": "CEI DIRET CID FRANCO, VER.",
                    "sigla": "",
                    "dre": {
                        "uuid": "7e47b03e-3957-44bf-b51c-6cd432ef2ac8",
                        "codigo_eol": "108200",
                ...
                "id": 89,
                "processo_regularidade": "6016.2023/0038451-6"
            },
            "uuid": "c0712fd8-d5d1-48d1-bdaa-64526270322e",
            "valor_capital": "0.00",
            "valor_custeio": "0.00",
            "valor_livre": "11116.00",
            "acao_associacao": {
                "uuid": "2b048164-53dd-4f1a-bdb7-bf0d145026de",
                "id": 406,
                "nome": "PTRF Básico",
                "e_recursos_proprios": false,
                "acao": {
            ...
            "conta_associacao": {
                "uuid": "d82071e2-a1a8-4833-a4b6-e8e31234cdca",
                "nome": "Cartão",
                "status": "ATIVA",
                "solicitacao_encerramento": null,
                "data_inicio": "2022-09-01"
        ...
        {
            "associacao": {
                "uuid": "1bac71ac-28d2-4aad-98f2-944e4e3573b7",
                "ccm": "4.102.951-8",
                "cnpj": "10.903.897/0001-17",
                "email": "ceijmacedonia@sme.prefeitura.sp.gov.br",
                "nome": "ASSOCIACAO DE PAIS E MESTRES DO CEI JARDIM MACEDONIA",
                "unidade": {
                    "uuid": "6a9d0279-0506-4c32-aa0b-850476a5693e",
                    "codigo_eol": "400093",
                    "tipo_unidade": "CEI DIRET",
                    "nome": "JARDIM MACEDONIA",
                    "nome_com_tipo": "CEI DIRET JARDIM MACEDONIA",
                    "sigla": "",
                    "dre": {
                        "uuid": "7e47b03e-3957-44bf-b51c-6cd432ef2ac8",
                        "codigo_eol": "108200",
                ...
                "id": 100,
                "processo_regularidade": "6016.2023/0038466-4"
            },
            "uuid": "742fc8c6-7f04-411b-90be-faea5acf8306",
            "valor_capital": "0.00",
            "valor_custeio": "0.00",
            "valor_livre": "12526.00",
            "acao_associacao": {
                "uuid": "1a9392bd-e3d6-4c67-87fa-8e2c6d689620",
                "id": 416,
                "nome": "PTRF Básico",
                "e_recursos_proprios": false,
                "acao": {
            ...
            "conta_associacao": {
                "uuid": "348d5ce6-eaab-40d1-b959-dc728b551d31",
                "nome": "Cartão",
                "status": "ATIVA",
                "solicitacao_encerramento": null,
                "data_inicio": "2022-09-01"
