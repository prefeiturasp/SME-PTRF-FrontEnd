...
describe("VincularUnidades", () => {
  ...
  it("deve renderizar o componente corretamente", () => {
    renderWithProviders(<VincularUnidades tipoContaUUID="uuid" />);
  ...
  it("deve renderizar o botão de vincular unidade", () => {
    renderWithProviders(<VincularUnidades tipoContaUUID="uuid" />);
  ...
  it("deve chamar a função de vincular unidade quando clicar", async () => {
    ...
    const button = screen.getByRole("button", { name: /Vincular unidade/i });
