...
import {getUnidadesPorAcao, getAcao, deleteLancamento, deleteAcoesAssociacoesEmLote} from "../../../../../../services/sme/Parametrizacoes.service"
...
export const AssociacoesDaAcao = () => {
    ...
    const onDesvinculaAssociacaoTrue = async () => {
        setShowConfirmaDesvinculo(false);
        try {
            const result = await deleteLancamento(acaoAssociacaoUuid);
