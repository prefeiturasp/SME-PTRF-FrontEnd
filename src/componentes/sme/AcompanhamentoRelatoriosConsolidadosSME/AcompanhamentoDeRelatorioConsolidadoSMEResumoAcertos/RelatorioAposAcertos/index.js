...
export const RelatorioAposAcertos = ({}) => {
    // {prestacaoDeContasUuid, analiseAtualUuid, podeGerarPrevia}
            ...
            <div className="relacao-bens-container mt-5">
                ...
                <article>
                    ...
                    <div className="actions">
                        <button onClick={(e) => console.log('')} type="button" className="btn btn-outline-success mr-2">Gerar prévia</button>
                    </div>
