            ...
            <div className="card-deck mt-4">
                ...
                <div className="card">
                    <div className="card-body card-info-devolucao-para-acerto-dre pb-1">
                        ...
                        <p className="card-text texto-info pb-0">{analiseSequenciaVisualizacao?.versao}</p>
                    </div>
                </div>
                <div className="card">
                    <div className="card-body card-info-devolucao-para-acerto-dre pb-1">
                        ...
                        <p className="card-text texto-info pb-0">{dataTemplate(null, null, analiseSequenciaVisualizacao?.sequenciaConferencia?.data_devolucao)}</p>
                    </div>
                </div>
                <div className="card">
                    <div className="card-body card-info-devolucao-para-acerto-dre pb-1">
                        ...
                        <p className="card-text texto-info pb-0">{dataTemplate(null, null, analiseSequenciaVisualizacao?.sequenciaConferencia?.data_limite)}</p>
                    </div>
                </div>
                <div className="card">
                    <div className="card-body card-info-devolucao-para-acerto-dre pb-1">
                        ...
                        <p className="card-text texto-info pb-0">{dataTemplate(null, null, analiseSequenciaVisualizacao?.sequenciaConferencia?.data_retorno_analise)}</p>
                    </div>
                </div>
            </div>
        )
