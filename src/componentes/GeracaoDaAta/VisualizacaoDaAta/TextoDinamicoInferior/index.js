    ...
    return(
        <div className="row">
            <div className="col-12">
                <p>O(a) Senhor(a) {dadosAta.presidente_reuniao ? dadosAta.presidente_reuniao : "___"} esclareceu que as despesas atenderam às prioridades registradas na(s) ata(a) da(s) reunião(ões) da Associação e em seguida  informou que ao término do período de realização das despesas do {retornaDadosAtaFormatado("periodo.referencia")}, restaram na conta nº {dadosAta.conta_associacao.numero_conta ? dadosAta.conta_associacao.numero_conta : "___"} do {dadosAta.conta_associacao.banco_nome ? dadosAta.conta_associacao.banco_nome : "___"}, agência {dadosAta.conta_associacao.agencia ? dadosAta.conta_associacao.agencia : "___"} os valores de R${valorTemplate(infoAta.totais.despesas_no_periodo_custeio)} para despesas de custeio e R${valorTemplate(infoAta.totais.despesas_no_periodo_capital)}, para despesas de capital, totalizando de R${valorTemplate(infoAta.totais.despesas_no_periodo)}, valores estes que foram reprogramados.</p>
                <p>{dadosAta.comentarios ? dadosAta.comentarios : ""}</p>
                <p>Os membros do Conselho Fiscal, à vista dos registros contábeis e verificando nos documentos apresentados a exatidão das despesas realizadas, julgaram exata a presente prestação de contas considerando-a em condições de ser {retornaDadosAtaFormatado("parecer_conselho")} e emitindo parecer {retornaDadosAtaFormatado("parecer_conselho")} à sua aprovação. Esgotados os assuntos o(a) senhor(a) presidente ofereceu a palavra a quem dela desejasse fazer uso e, como não houve manifestação agradeceu a presença de todos, considerando encerrada a reunião, a qual eu, {dadosAta.secretario_reuniao ? dadosAta.secretario_reuniao : "___"} lavrei-a na presente ata, que vai por mim assinada e pelos demais presentes.</p>
