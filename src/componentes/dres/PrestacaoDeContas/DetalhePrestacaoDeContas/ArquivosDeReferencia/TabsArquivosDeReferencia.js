    ...
    <>
      ...
      <nav>
        ...
        >
          {infoAta &&
            infoAta.contas &&
            infoAta.contas.length > 0 &&
            infoAta.contas.map((conta, index) => (
              <Fragment key={conta.conta_associacao.uuid}>
                <a
                  ...
                  className={`nav-link btn-escolhe-acao ${
                    clickBtnEscolheConta[index] ? "btn-escolhe-acao-active" : ""
                  }`}
      ...
      {infoAtaPorConta &&
      infoAtaPorConta.conta_associacao &&
      infoAtaPorConta.conta_associacao.uuid ? (
              ...
              >
                <AnalisesDeContaDaPrestacao
                  ...
                  handleChangeAnalisesDeContaDaPrestacao={
                    rest.handleChangeAnalisesDeContaDaPrestacao
                  }
