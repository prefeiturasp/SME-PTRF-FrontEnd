...
export const DevolucoesPrestacaoDeContasStatusDevolvido = ({prestacaoDeContas, retornaNumeroOrdinal}) => {
    return (
        <>
            {prestacaoDeContas && prestacaoDeContas.devolucoes_da_prestacao && prestacaoDeContas.devolucoes_da_prestacao.length > 0 && prestacaoDeContas.devolucoes_da_prestacao.map((devolucao, index) =>
                <Fragment key={index}>
                    ...
                    { index+1 === prestacaoDeContas.devolucoes_da_prestacao.length ? (
                        null
                    ):
