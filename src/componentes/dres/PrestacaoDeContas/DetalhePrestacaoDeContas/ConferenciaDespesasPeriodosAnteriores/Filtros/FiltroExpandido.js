    ...
    return (
        <>
            ...
            <div className="form-row align-items-center">
                ...
                <div className="form-group col">
                    <label htmlFor="filtrar_por_numero_de_documento">Número de documento</label>
                ...
                <div className="form-group col">
                    <label htmlFor="filtrar_por_tipo_de_documento">Tipo de documento</label>
                    <select
            ...
            <div className="form-row align-items-center">
                <div className="form-group col">
                    <label htmlFor="filtrar_por_tipo_de_pagamento">Forma de pagamento</label>
                    <select
            ...
            <div className="form-row align-items-center">
                <div className="form-group col">
                    <label htmlFor="select_filtrar_por_informacoes" id='lbl_filtrar_por_informacoes'>Informações</label>
                    <Select
                ...
                <div className="form-group col">
                    <label htmlFor="select_filtrar_por_conferencia" id='lbl_select_filtrar_por_conferencia'>Conferência</label>
                    <Select
                        ...
                        className='multiselect-filtrar-por-status'
                    >
                        {listaTagsConferencia && listaTagsConferencia.length > 0 && listaTagsConferencia.map(item => (
                            <Option key={item.id} value={item.nome}>{item.descricao}</Option>
                        ))}
                    </Select>
                </div>
            </div>
