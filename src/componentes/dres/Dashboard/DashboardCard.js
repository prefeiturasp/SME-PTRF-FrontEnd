                            ...
                            <div className="card-body">
                                <div className="card-text card-qtde-associacoes  mb-0 pb-3 d-flex justify-content-between">
                                    ...
                                    {card.quantidade_retornadas >= 1 &&
                                        <span data-tooltip-content={card.quantidade_retornadas > 1 ? '<p class="mb-0">Existem ' + card.quantidade_retornadas + ' prestações</p> <p class="mb-0">retornadas das U.Es</p>' : '<p class="mb-0">Existe ' + card.quantidade_retornadas + ' prestação</p><p class="mb-0"> retornada das U.Es</p>' } data-html={true}>
                                            <FontAwesomeIcon
                                    ...
                                    {card.quantidade_nao_recebida >= 1 &&
                                        <span data-tooltip-content={card.quantidade_nao_recebida > 1 ? '<p class="mb-0">'+ card.quantidade_nao_recebida + ' novas prestações não recebidas</p>' : '<p class="mb-0">' + card.quantidade_nao_recebida + ' nova prestação não recebida</p>' } data-html={true}>
                                            <FontAwesomeIcon
                                                style={{fontSize: '18px', marginLeft: "3px", color: '#C65D00'}}
                                                icon={faInfoCircle}
                                            />
