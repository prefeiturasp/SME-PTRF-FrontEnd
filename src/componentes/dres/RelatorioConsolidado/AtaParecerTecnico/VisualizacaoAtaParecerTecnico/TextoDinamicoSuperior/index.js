    ...
    return(
        <>
            ...
            <p className="texto-dinamico-superior">
                {retornaDadosAtaFormatado("data_reuniao")}, às {retornaDadosAtaFormatado("hora_reuniao")}, reuniu-se a Comissão de Prestação de Contas do PTRF da Diretoria Regional de Educação {dadosAta.dre.nome},
                instituída pela Portaria DRE-{dadosAta.dre.nome} nº {retornaDadosAtaFormatado("numero_portaria")} de {retornaDadosAtaFormatado("data_portaria")}, para análise das prestações de contas dos recursos transferidos pelo
