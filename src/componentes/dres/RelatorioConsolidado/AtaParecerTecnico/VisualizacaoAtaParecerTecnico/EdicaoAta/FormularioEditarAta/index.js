                ...
                <form>
                  ...
                  <div className="form-row mt-2">
                    <div className="col">
                      ...
                      <input
                        value={
                          values.stateFormEditarAta.numero_portaria ? values.stateFormEditarAta.numero_portaria : ""
                        }
                        onChange={(e) => {
                  ...
                  <FieldArray
                    ...
                    render={({ remove, push }) => (
                      <>
                        {values.listaPresentes &&
                          values.listaPresentes.length > 0 &&
                          values.listaPresentes.map((presente, index) => {
                            return (
                              <div key={index}>
                                <div className="form-row">
                                  <div className="col">
                                    <label htmlFor={`listaPresentes.rf_[${index}]`} className="mt-3">
                                      RF
                                    </label>
                                    <input
                                    ...
                                    <p className="mt-1 mb-0">
                                      <span className="text-danger">
                                        {formErrors && formErrors[index] ? formErrors[index] : null}
                                      </span>
                                    </p>
                                  </div>

                                  <div className="col-4">
                                    <label htmlFor={`listaPresentes.nome_[${index}]`} className="mt-3">
                                      Nome
                                    </label>
                                    <input
                                  ...
                                  <div className="col-4">
                                    <label htmlFor={`listaPresentes.cargo_[${index}]`} className="mt-3">
                                      Cargo
                                    </label>
                                    <input
                  ...
                  {values.stateFormEditarAta.eh_retificacao && (
                    <div className="form-row">
                      <div className="col-12">
                        <label htmlFor="stateFormEditarAta.motivo_retificacao" className="mb-0 mt-4">
                  ...
                  <p className="titulo-comentarios mt-5">
                    Comentários <span className="titulo-comentarios-opcional">(opcional)</span>
                  </p>
                  <div className="form-row">
                    <div className="col-12">
                      <label htmlFor="stateFormEditarAta.comentarios" className="mb-0">
                        Utilize esse campo para registrar possíveis dúvidas, discussões, esclarecimentos aparecidos
                        durante a reunião
                      </label>
                      <textarea
                        rows="3"
