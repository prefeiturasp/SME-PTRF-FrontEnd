                ...
                <div className="d-flex bd-highlight mt-2">
                    <div className="p-Y flex-grow-1 bd-highlight">
                        {props.observacao.observacao &&
                            <button onClick={()=>props.serviceOperacao({operacao:'deletar'})} type="button" className="btn btn-danger mt-2"> Apagar</button>
                        }
                    </div>
                    ...
                    <div className="p-Y bd-highlight">
                        <button disabled={!props.observacao.observacao} onClick={()=>props.serviceOperacao({operacao:'salvar'})} type="button" className="btn btn-success mt-2">Salvar</button>
                    </div>
                </div>
            </>
        )
