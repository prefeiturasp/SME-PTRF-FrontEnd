...
export const TecnicoDreForm = ({show, handleClose, onSubmit, handleChange, validateForm, initialValues}) => {
                        ...
                        return(
                            <form method="POST" id="membrosForm" onSubmit={props.handleSubmit}>
                                ...
                                <div className="d-flex  justify-content-end pb-3 mt-3">
                                    ...
                                    <button type="submit" className="btn btn-success mt-2">Adicionar</button>
                                </div>
                            </form>
                        );
                    }}
