...
export const getArquivosDeCargaFiltros = async (
  ...
  return (
    await api.get(
      `/api/arquivos/?tipo_carga=${tipo_carga}${
...
export const getDownloadModeloArquivoDeCarga = async (
  tipo_arquivo_de_carga
) => {
  return await api
...
export const patchAlterarFiqueDeOlhoRelatoriosConsolidadosDre = async (
  payload
) => {
  return (
    await api.patch(
...
export const getFiltros = async (
  ...
  return (
    await api.get(
      `/api/acoes-associacoes/?nome=${nome}${
        acao__uuid ? "&acao__uuid=" + acao__uuid : ""
      }${status ? "&status=" + status : ""}${
...
export const putAtualizarAcertosLancamentos = async (
  acerto_lancamento_uuid,
  payload
) => {
  return (
    await api.patch(
...
export const putAtualizarAcertosDocumentos = async (
  acerto_lancamento_uuid,
  payload
) => {
  return (
...
export const getAcertosDocumentosFiltrados = async (
  nome = "",
  categoria = "",
  ativo = "",
  ...
  return (
    await api.get(
      `/api/tipos-acerto-documento/?nome=${nome}${
        categoria ? "&categoria=" + categoria : ""
      }${ativo ? "&ativo=" + ativo : ""}${
        documento_relacionado
...
export const getUnidadesPorAcao = async (
  acao_uuid,
  pagina = 1,
  nome = "",
  informacoes = []
...
export const getAcoesPDDECategorias = async () => {
    return (await api.get(`/api/programas-pdde/?page1&page_size=100`, authHeader())).data
};
export const postAcoesPDDECategorias = async (payload) => {
    return (await api.post(`/api/programas-pdde/`, payload, authHeader())).data
};
export const patchAcoesPDDECategorias = async (uuid, payload) => {
    return (await api.patch(`/api/programas-pdde/${uuid}/`, payload, authHeader())).data
};
export const deleteAcoesPDDECategorias = async (categoriaUuid) => {
    return (await api.delete(`/api/programas-pdde/${categoriaUuid}/`, authHeader())).data
};
...
export const getAcoesPDDE = async (nome="", categoria="", currentPage=1, rowsPerPage=20) => {
    return (await api.get(`/api/acoes-pdde/?nome=${nome}&programa__uuid=${categoria}&page=${currentPage}&page_size=${rowsPerPage}`, authHeader())).data
};
...
export const getEspecificacoesMateriaisServicos = async (
  filter,
  currentPage
) => {
...
export const postMotivosDevolucaoTesouro = async (payload) => {
  return await api.post(
    `api/motivos-devolucao-ao-tesouro/`,
    {
      ...payload,
    },
    authHeader()
...
export const patchMotivosDevolucaoTesouro = async (
  uuidMotivoDevolucaoTesouro,
  payload
) => {
  return await api.patch(
...
export const deleteMotivoDevolucaoTesouro = async (
  uuidMotivoDevolucaoTesouro
) => {
  return await api.delete(
    `api/motivos-devolucao-ao-tesouro/${uuidMotivoDevolucaoTesouro}/`,
...
export const postMotivoAprovacaoPcRessalva = async (payload) => {
  return await api.post(
    `api/motivos-aprovacao-ressalva-parametrizacao/`,
    {
      ...payload,
    },
    authHeader()
...
export const patchMotivosAprovacaoPcRessalva = async (
  uuidMotivoAprovacaoPcRessalva,
  payload
) => {
  return await api.patch(
    `api/motivos-aprovacao-ressalva-parametrizacao/${uuidMotivoAprovacaoPcRessalva}/`,
    {
      ...payload,
    },
    authHeader()
