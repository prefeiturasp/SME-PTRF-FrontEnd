...
const setAnaliseDre = async () => {
    ...
    let dados_analise_dre_update = {
        ...
        [`usuario_${visoesService.getUsuarioLogin()}`]: {
            ...
            conferencia_de_despesas_periodos_anteriores: {
                conta_uuid: analise_dre_usuario_logado && analise_dre_usuario_logado.conferencia_de_despesas_periodos_anteriores && analise_dre_usuario_logado.conferencia_de_despesas_periodos_anteriores.conta_uuid ? analise_dre_usuario_logado.conferencia_de_despesas_periodos_anteriores.conta_uuid : '',
                expanded: analise_dre_usuario_logado && analise_dre_usuario_logado.conferencia_de_despesas_periodos_anteriores && analise_dre_usuario_logado.conferencia_de_despesas_periodos_anteriores.expanded ? analise_dre_usuario_logado.conferencia_de_despesas_periodos_anteriores.expanded : [],
                paginacao_atual: analise_dre_usuario_logado && analise_dre_usuario_logado.conferencia_de_despesas_periodos_anteriores && analise_dre_usuario_logado.conferencia_de_despesas_periodos_anteriores.paginacao_atual ? analise_dre_usuario_logado.conferencia_de_despesas_periodos_anteriores.paginacao_atual : 0,
            },            
            conferencia_de_documentos: {
